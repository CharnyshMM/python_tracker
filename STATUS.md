...
Поддержание разных приоритетов дел позволит составлять примерный план дел. В работе команды поддержки есть список нерешенных задач, и в нем поддерживается иерархия важности проблем. Если поступает информация о серьезной ошибке, ее приоритет ставят максимально высоким, она видна первой. При попытке поставить статус "В работе" и начать работу с задачей менее важной будет выдано предупреждение или даже отмена действия.
...
**11) Привязка файлов к делу, списку дел.**
...
7) Разработка веб-интерфейса.
   (Максимум: сделать регистрацию пользователей при помощи уже существующих аккаунтов в Google, Yandex, Facebook.  
